...
(function ($) {
    $.extend({
    	...
    	table: {
            ...
            selectGardenName: function(datas,value) {
            	var actions = [];
            	 $.each(datas, function(index, garden) {
                    if (garden.dictValue == value) {
                    	actions.push("<span class='badge badge-" + garden.dictCode + "'>" + garden.dictLabel + "</span>");
                        return false;
                    }
            	 });
                return actions.join('');
